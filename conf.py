...
BLOG_AUTHOR = "sjj"  # (translatable)
BLOG_TITLE = "Lightly Seared On The Reality Grill"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://samjuvonen.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://samjuvonen.com/"
BLOG_EMAIL = "info@samjuvonen.com"
BLOG_DESCRIPTION = "Look ma, a blog!"  # (translatable)
...
LICENCE = """<a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">
